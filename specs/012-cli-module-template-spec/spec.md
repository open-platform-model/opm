...
**Feature Branch**: `012-cli-module-template-spec`  
**Created**: 2026-01-23  
**Status**: Draft  
...
## Relationship to 002-cli-spec

This specification extends the OPM CLI v2 specification (002-cli-spec), specifically:
...
Templates follow the new project structure conventions from 002-cli-spec:
...
- **FR-007**: Generated `module.cue` MUST use package `main` and follow the project structure conventions from 002-cli-spec.
