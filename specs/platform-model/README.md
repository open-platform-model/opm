...
See [013-cli-render-spec](../application-model/013-cli-render-spec/spec.md) for the render pipeline implementation.
...
./create-new-feature.sh "Your spec description" --model platform
```
