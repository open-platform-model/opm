...
**Branch**: `006-cli-module-template-spec` | **Date**: 2026-01-23 | **Spec**: [spec.md](./spec.md)  
**Extends**: [004-cli-spec](../004-cli-spec/plan.md)
...
|--------|----------|--------|
| **Language** | Go 1.22+ | 004-cli-spec |
| **CLI Framework** | spf13/cobra | 004-cli-spec |
| **Template Embedding** | Go `embed` package | FR-014 |
| **Template Rendering** | Go `text/template` | data-model.md placeholders |
| **Project Location** | `cli/internal/templates/`, `cli/internal/cmd/mod/` | 004-cli-spec structure |
| **Exit Codes** | [004-cli-spec/contracts/exit-codes.md](../004-cli-spec/contracts/exit-codes.md) | Shared |
...
- `io/fs` (stdlib)
- Existing 004-cli-spec dependencies (cobra, etc.)
